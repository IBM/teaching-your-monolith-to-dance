...
AdminTask.addMemberToGroup('[-memberUniqueName uid=skywalker,o=defaultWIMFileBasedRealm -groupUniqueName cn=SecureShopper,o=defaultWIMFileBasedRealm]')
...
AdminConfigVar_6=AdminTask.createDatasource(AdminConfigVar_5, ["-componentManagedAuthenticationAlias", "DBUser" , "-configureResourceProperties", "[[databaseName java.lang.String ORDERDB] [driverType java.lang.Integer 4] [serverName java.lang.String cos-db-twas.db.svc] [portNumber java.lang.Integer 50000] ]" , "-dataStoreHelperClassName", "com.ibm.websphere.rsadapter.DB2UniversalDataStoreHelper" , "-xaRecoveryAuthAlias", "DBUser" , "-name", "OrderDS" , "-jndiName", "jdbc/orderds" ])
...
AdminConfigVar_9=AdminTask.createDatasource(AdminConfigVar_5, ["-componentManagedAuthenticationAlias", "DBUser" , "-configureResourceProperties", "[[databaseName java.lang.String INDB] [driverType java.lang.Integer 4] [serverName java.lang.String cos-db-twas.db.svc] [portNumber java.lang.Integer 50000] ]" , "-dataStoreHelperClassName", "com.ibm.websphere.rsadapter.DB2UniversalDataStoreHelper" , "-xaRecoveryAuthAlias", "DBUser" , "-name", "INDS" , "-jndiName", "jdbc/inds" ])
